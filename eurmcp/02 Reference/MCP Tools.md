...
- Case search title queries use AND semantics. `provision` searches require an official paragraph that directly links the article to the instrument. `interpreted_celex` remains an instrument-level metadata filter.
